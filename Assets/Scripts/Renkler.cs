...
public static class Renkler
{
    ...
    static Renkler()
    {
        ...
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(140, 191, 124, 255)));
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(0, 0, 255, 255)));
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(227, 252, 0, 255)));
        ...
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(175, 50, 50, 255)));
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(0, 192, 0, 255)));
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(100, 0, 100, 255)));
        ...
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(150, 0, 64, 255)));
        RenkSozlugu.Add(RenkSozlugu.Count,(new Color32(200, 105, 100, 255)));
